...
| `get_user_by_subscription_customer(cust)` | dict 또는 None | — |
| `get_user_by_subscription_id(sub_id)` | dict 또는 None | — |
...
- `billing.py` — get_user_by_subscription_customer, get_user_by_subscription_id, set_subscription, clear_subscription
